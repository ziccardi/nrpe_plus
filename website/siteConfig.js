...
const siteConfig = {
  title: 'NRPE++', // Title for your website.
  tagline: 'This page is under construction',
  url: 'https://ziccardi.github.io', // Your website URL
  baseUrl: '/nrpe_plus/', // Base URL for your project */
  // For github.io type URLs, you would set the url and baseUrl like:
  //   url: 'https://facebook.github.io',
  //   baseUrl: '/test-site/',

  // Used for publishing and more
  projectName: 'nrpe_plus',
  ...
  headerLinks: [
    ...
    {href: 'https://github.com/ziccardi/nrpe_plus', label: 'GitHUB' }
    // {doc: 'doc1', label: 'Docs'},
    // {doc: 'doc4', label: 'API'},
